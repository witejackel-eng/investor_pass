...
| Payments | PARTIAL | Subscription | `/api/checkout`, `/api/webhooks/razorpay`, `/api/webhooks/paypal` | Upgrade + account views | Razorpay/PayPal adapters built, mock mode default; HMAC-verified webhooks fail closed. Awaiting live processor keys. USD $19/$149, INR ₹999/₹7,999. |
