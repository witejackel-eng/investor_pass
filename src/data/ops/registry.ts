...
export const FEATURES: {
  ...
  { name: "Search", status: "LIVE", route: "/#/view=search", data: "Passage+Source (pg_trgm)", api: "/api/search", tests: "bun test", notes: "deterministic, no AI" },
  ...
  { name: "Compare", status: "LIVE", route: "/#/view=compare", data: "theme/person aggregates", api: "/api/compare", tests: "bun test", notes: "V1 A×B×theme" },
  ...
  { name: "Save (bookmarks/collections)", status: "LIVE", route: "/#/view=bookmarks, library", data: "Bookmark/Collection", api: "/api/bookmarks, /collections", tests: "bun test", notes: "auth-scoped" },
  ...
  { name: "Pro entitlement", status: "PARTIAL", route: "upgrade view", data: "Subscription", api: "/api/checkout (mock)", tests: "bun test", notes: "awaiting live plan keys ($9/$79)" },
...
export const ROUTES: {
  ...
  { url: "/#/view=search", page: "Search (SPA)", auth: "public (pro depth)", component: "SearchView", data: "trigram search", api: "/api/search" },
  { url: "/#/view=compare", page: "Compare (SPA)", auth: "public", component: "CompareView", data: "aggregates", api: "/api/compare" },
  { url: "/#/view=library|bookmarks|watchlist", page: "Personal (SPA)", auth: "auth", component: "Library views", data: "Bookmark/Collection/Follow", api: "/api/bookmarks, /collections, /follows" },
  { url: "/#/view=upgrade|login|signup", page: "Commerce/Auth (SPA)", auth: "public", component: "views-auth", data: "User/Subscription", api: "/api/checkout, /api/auth/*" },
