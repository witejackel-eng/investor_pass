  ...
  return (
    <div className="space-y-4">
      ...
      <div className="ops-card text-xs">
        ...
        <p className="mt-1"><b>Deployed commit:</b> <code>{process.env.VERCEL_GIT_COMMIT_SHA?.slice(0, 7) ?? "local/unknown"}</code>{process.env.VERCEL_GIT_COMMIT_REF ? ` (${process.env.VERCEL_GIT_COMMIT_REF})` : ""}</p>
